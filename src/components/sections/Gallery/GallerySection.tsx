...
const Courses = ({
  title = "Courses",
  description = "Carefully curated programs designed to transform beginners into industry professionals",
  items,
}: CoursesProps) => {
  ...
  const courseItems: CoursesItem[] = (courses || []).map((course) => ({
    id: course.id,
    title: course.title,
